  ...
  return (
    <div className={`navbar ${isMenuOpen ? 'open' : ''}`}>
      ...
      <div className="nav-login-cart">
        <Link to='/login' onClick={() => { setMenu("login"); toggleMenu(); }}><button>Login</button></Link>
        <div style={{ position: 'relative' }}>
          <Link to='/cart' onClick={() => { setMenu("cart"); toggleMenu(); }}><img src={cart_icon} alt="cart_icon" /></Link>
